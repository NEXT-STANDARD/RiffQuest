...
- ⚡ **レベルシステム**: 練習するほどレベルアップ（RPG風・レベルキャップなし）
- 🎥 **OBS連携**: OBSオーバーレイで配信中も統計表示
- 🏆 **世界ランキング**: Supabase統合で世界中のユーザーと競える（オプション）
...
### レベルシステム（RPG風）
- **1分練習 = 10 XP**
- **レベルN→N+1に必要なXP = N × 100**
- Lv1→Lv2: 100 XP、Lv10→Lv11: 1,000 XP
- レベルキャップなし！

## 🏆 世界ランキング（オプション）

**Supabase無料枠で世界中のユーザーと競える！**

詳細な実装ガイド: **[docs/SUPABASE_SETUP.md](docs/SUPABASE_SETUP.md)**
...
その他の方法: **[LEADERBOARD.md](LEADERBOARD.md)** - GitHub Issues、Firebase、Discord Bot、Googleスプレッドシート
